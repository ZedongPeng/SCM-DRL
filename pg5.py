# -*- coding: utf-8 -*-
# @Author: Zedong Peng
# @Date:   2019-05-31 11:17:50
# @Last Modified by:   Zedong Peng
# @Last Modified time: 2019-06-27 00:10:08
...
from supply_distribution5 import SupplyDistribution
import pandas as pd
    ...
    def sample_trajectory(self, env, animate_this_episode):
        ...
        while True:
            if animate_this_episode:
                ...
                time.sleep(0.1)
            obs.append(ob)
            ac = tf.get_default_session().run(
                self.sy_sampled_ac, feed_dict={self.sy_ob_no: ob[None]})
            ac = ac[0]
            acs.append(ac)
